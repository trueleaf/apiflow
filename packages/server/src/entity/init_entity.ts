...
const INITIAL_SERVER_ROUTES = [
  ...
  {
    _id: '6f1e85a991093c38a013c401',
    groupName: 'api文档-环境管理',
    method: 'post',
    name: '新增环境',
    path: '/api/project/environment',
  },
  {
    _id: '6f1e85a991093c38a013c402',
    groupName: 'api文档-环境管理',
    method: 'put',
    name: '修改环境',
    path: '/api/project/environment',
  ...
  {
    _id: '6f1e85a991093c38a013c404',
    groupName: 'api文档-环境管理',
    method: 'get',
    name: '获取环境列表',
    path: '/api/project/environment/list',
  },
  {
    _id: '6f1e85a991093c38a013c405',
    groupName: 'api文档-环境管理',
    method: 'get',
    name: '获取环境变量列表',
    path: '/api/project/environment/variable/list',
  },
  {
    _id: '6f1e85a991093c38a013c406',
    groupName: 'api文档-环境管理',
    method: 'put',
    name: '批量保存环境变量',
    path: '/api/project/environment/variable/batch',
  },
  {
