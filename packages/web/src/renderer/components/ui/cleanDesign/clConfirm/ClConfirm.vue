...
const checkboxLabel = computed(() => props.checkboxText || t('不再提示'))
const confirmLabel = computed(() => props.confirmButtonText || t('确定'))
const cancelLabel = computed(() => props.cancelButtonText || t('取消'))
const handleConfirm = () => {
