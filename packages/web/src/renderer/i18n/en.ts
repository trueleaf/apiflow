export default {
  ...
  点击工具栏按钮新增文档或者鼠标右键新增: 'Click toolbar button to add document or right-click to add',
  ...
  是否要保存对接口的修改: 'Save modifications to {msg} interface?',
  '维护人员：': 'Maintainer: ',
  '创建人员：': 'Creator: ',
  '累计用时：': 'Total Time: ',
  '更新日期：': 'Update Date: ',
  '创建日期：': 'Create Date: ',
  '确定批量删除个节点?': 'Confirm batch delete {msg} nodes?',
  '确定删除节点?': 'Confirm delete {msg} node?',
  ...
  '此操作将删除条记录, 是否继续?': 'This operation will delete {msg} records, continue?',
  用户: 'User',
