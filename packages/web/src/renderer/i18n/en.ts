export default {
  ...
  请先选择项目文件夹: 'Please select project folder first',
  'AI 正在分析项目代码，请稍候...': 'AI is analyzing project code, please wait...',
  '步骤 1/3': 'Step 1/3',
  '步骤 2/3': 'Step 2/3',
  '步骤 3/3': 'Step 3/3',
  ...
  选择框架类型: 'Select Framework Type',
  路由代码: 'Route Code',
  粘贴包含路由定义的代码文件内容: 'Paste code file content containing route definitions',
  粘贴包含路由定义的代码: 'Paste code containing route definitions',
  分析代码: 'Analyze Code',
  '分析中...': 'Analyzing...',
  分析成功: 'Analysis Successful',
  代码分析失败: 'Code Analysis Failed',
  'AI 正在分析路由定义，请稍候...': 'AI is analyzing route definitions, please wait...',
  请输入代码内容: 'Please enter code content',
  请选择框架类型: 'Please select framework type',
  '支持 .json / .yaml 格式': 'Supports .json / .yaml format',
  请输入URL地址: 'Please enter URL',
  获取: 'Fetch',
  ...
  '请粘贴 JSON 或 YAML 格式的内容': 'Please paste JSON or YAML content',
  解析内容: 'Parse Content',
  ...
  版权信息: 'Copyright',
  下载源: 'Update Source',
  下载源配置: 'Update Source Settings',
  下载源类型: 'Source Type',
  自定义地址: 'Custom URL',
  请输入自定义更新服务器地址: 'Please enter custom update server URL',
  下载源配置已保存: 'Update source settings saved',
  保存失败: 'Failed to save',
  // Advanced Search (new)
  HTTP节点: 'HTTP Node',
  ...
  请输入更新源URL: 'Please enter the update source URL',
  'URL格式不正确': 'Invalid URL format',
  下载速度: 'Download Speed',
  网络连接超时: 'Network connection timeout',
  '更新包下载失败，请检查网络连接': 'Failed to download update, please check network connection',
  '安装包校验失败，请重新下载': 'Package verification failed, please download again',
