...
export default {
  ...
  '确定要删除 "{description}" 本地数据吗？此操作将清空该存储中的所有数据。':
    'Are you sure you want to delete local data \"{description}\"? This will clear all data in the storage.',
  '确定要删除 "{description}" 本地数据吗？此操作将永久删除该本地数据项。':
    'Are you sure you want to delete local data \"{description}\"? This will permanently delete the local data item.',
