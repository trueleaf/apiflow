...
export default {
  ...
  更多操作: 'その他の操作',
  快捷操作: 'クイック操作',
  点击工具栏按钮新增文档或者鼠标右键新增: 'ツールバーボタンをクリックしてドキュメントを追加するか、右クリックで追加',
  不能为空: '空にできません',
  新建文档: '新しいドキュメント',
  新建文件夹: '新しいフォルダ',
  剪切: '切り取り',
  ...
  发送并清空: '送信してクリア',
  心跳包内容: 'ハートビート内容',
  启用自动心跳: '自動ハートビートを有効にする',
  心跳间隔时间: 'ハートビート間隔時間',
  毫秒: 'ミリ秒',
  自定义心跳内容: 'カスタムハートビート内容',
  心跳包发送成功: 'ハートビート送信成功',
  心跳包发送失败: 'ハートビート送信失敗',
  请输入心跳包内容: 'ハートビート内容を入力してください',
  心跳包间隔不能为空: 'ハートビート間隔は空にできません',
  心跳包间隔必须大于0: 'ハートビート間隔は0より大きくなければなりません',
  自动心跳已启用: '自動ハートビートが有効になりました',
  自动心跳已停止: '自動ハートビートが停止しました',
  发送间隔: '送信間隔',
