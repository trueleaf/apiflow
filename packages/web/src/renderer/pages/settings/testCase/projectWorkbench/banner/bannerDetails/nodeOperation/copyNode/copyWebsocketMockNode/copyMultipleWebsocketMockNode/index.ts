...
const node: ModelNode = {
  modelName: "copyMultipleWebsocketMockNode",
  ...
  atomicFunc: [
  {
    ...
    "operationSteps": [
      {
        "id": "1",
        "name": "多选3个websocketMockNode节点并批量复制"
      },
      {
        "id": "2",
        "name": "在banner空白区域粘贴"
    ...
    "expectedResults": [
      {
        "id": "1",
        "name": "粘贴成功,根节点下新增3个websocketMockNode节点"
      }
    ],
    "checkpoints": [
      {
  ...
  },
  {
    ...
    "precondition": [
      {
        "id": "1",
        "name": "项目中包含3个websocketMockNode节点和1个folder节点"
      }
    ],
    "operationSteps": [
      {
    ...
    "expectedResults": [
      {
        "id": "1",
        "name": "粘贴成功,folder下新增3个websocketMockNode节点"
      }
    ],
    "checkpoints": [
      {
  ...
  },
  {
    ...
    "precondition": [
      {
        "id": "1",
        "name": "项目A中包含3个websocketMockNode节点"
      },
      {
        "id": "2",
        "name": "项目B中包含folder节点"
    ...
    "expectedResults": [
      {
        "id": "1",
        "name": "粘贴成功,项目B的folder下新增3个websocketMockNode节点"
      }
    ],
    "checkpoints": [
      {
  ...
  },
  {
    ...
    "expectedResults": [
      {
        "id": "1",
        "name": "粘贴成功,项目B的根节点下新增3个websocketMockNode节点"
      }
    ],
    "checkpoints": [
      {
  ...
  },
  {
    ...
    "precondition": [
      {
        "id": "1",
        "name": "项目中包含至少4个websocketMockNode节点"
      }
    ],
    "operationSteps": [
      {
      ...
      {
        "id": "2",
        "name": "右键点击另一个websocketMockNode节点"
      }
    ],
    "expectedResults": [
      {
  ...
  },
  {
    ...
    "operationSteps": [
      ...
      {
        "id": "2",
        "name": "单击选中另一个websocketMockNode节点"
      },
      {
        "id": "3",
        "name": "按下Ctrl+V"
