...
const node: ModelNode = {
  modelName: "moveSingleHttpMockNode",
  ...
  atomicFunc: [
  {
    ...
    "precondition": [
      ...
      {
        "id": "2",
        "name": "项目中存在至少一个httpMockNode节点,且位于某个folder内"
      },
      {
        "id": "3",
    ...
    "operationSteps": [
      {
        "id": "1",
        "name": "在banner区域找到目标httpMockNode节点(显示mock图标)"
      },
      {
        "id": "2",
        "name": "鼠标左键按住该httpMockNode节点"
      },
      {
        "id": "3",
    ...
    "checkpoints": [
      {
        "id": "1",
        "name": "httpMockNode节点type为\"httpMock\"(Banner.vue:63-110)"
      },
      {
        "id": "2",
        "name": "handleCheckNodeCouldDrop对httpMockNode应用相同拖拽规则(Banner.vue:581-599)"
      },
      {
        "id": "3",
    ...
    "notes": [
      {
        "id": "1",
        "name": "httpMockNode显示\"mock\"文字图标区分于普通http节点"
      },
      {
        "id": "2",
        "name": "httpMockNode可能有state状态指示器(running/starting/stopping/error)"
      },
      {
        "id": "3",
  ...
  },
  {
    ...
    "precondition": [
      ...
      {
        "id": "2",
        "name": "项目中存在至少一个httpMockNode节点和一个folder节点"
      },
      {
        "id": "3",
        "name": "httpMockNode节点当前不在目标folder内"
      },
      {
        "id": "4",
    ...
    "expectedResults": [
      ...
      {
        "id": "2",
        "name": "释放后httpMockNode节点移动到folder内部"
      },
      {
        "id": "3",
        "name": "folder自动展开显示新加入的httpMockNode节点"
      },
      {
        "id": "4",
    ...
    "checkpoints": [
      {
        "id": "1",
        "name": "handleCheckNodeCouldDrop对httpMockNode的inner放置返回true(Banner.vue:596-598)"
      },
      {
        "id": "2",
        "name": "dragNode设置newPid = dropData._id, newSort = Date.now()(curd-node.ts:590-593)"
      },
      {
        "id": "3",
    ...
    "notes": [
      {
        "id": "1",
        "name": "httpMockNode拖入folder不影响其Mock服务运行状态"
      },
      {
        "id": "2",
      ...
      {
        "id": "3",
        "name": "包含运行中Mock的folder会显示folder-mock-indicator指示器"
      }
    ]
  },
  {
    ...
    "operationSteps": [
      {
        "id": "1",
        "name": "在banner区域找到需要调整顺序的httpMockNode节点"
      },
      {
        "id": "2",
        "name": "鼠标左键按住该httpMockNode节点"
    ...
    "checkpoints": [
      ...
      {
        "id": "3",
        "name": "type !== \"inner\"时newPid来自父节点(curd-node.ts:599-601)"
      }
    ],
    "notes": [
      {
      ...
      {
        "id": "2",
        "name": "httpMockNode顺序调整不影响Mock服务运行状态"
      },
      {
        "id": "3",
  ...
  },
  {
    ...
    "precondition": [
      ...
      {
        "id": "2",
        "name": "项目中存在至少一个httpMockNode节点和一个非folder节点"
      },
      {
        "id": "3",
        "name": "el-tree组件的draggable属性为true"
    ...
    "operationSteps": [
      {
        "id": "1",
        "name": "在banner区域找到httpMockNode节点"
      },
      {
        "id": "2",
        "name": "鼠标左键按住该httpMockNode节点"
    ...
    "notes": [
      ...
      {
        "id": "2",
        "name": "httpMockNode的拖拽限制与httpNode完全一致"
      }
    ]
  }
],
