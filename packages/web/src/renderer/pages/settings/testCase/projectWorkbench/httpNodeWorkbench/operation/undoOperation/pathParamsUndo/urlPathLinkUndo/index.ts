...
const node: ModelNode = {
  ...
  atomicFunc: [
  {
    ...
    "operationSteps": [
      {
        "id": "1",
        "name": "在url输入框粘贴http://demo.com/user{id}"
      },
      {
        "id": "2",
        "name": "失焦(blur)触发url解析,path参数自动提取到path参数表格"
      },
      {
        "id": "3",
        "name": "点击撤销按钮"
    ...
    "expectedResults": [
      {
        "id": "1",
        "name": "第一次撤销后path参数表格清空,url恢复为http://demo.com/user{id}"
      },
      {
        "id": "2",
        "name": "第二次撤销后url值为空"
    ...
    "checkpoints": [
      {
        "id": "1",
        "name": "url blur事件触发path参数解析并记录操作历史"
      }
    ],
    "notes": [
      {
        "id": "1",
        "name": "url与path参数联动,blur时自动解析path参数"
      }
    ]
  },
  {
    ...
    "expectedResults": [
      {
        "id": "1",
        "name": "第一次按快捷键后path参数表格清空,url恢复为http://demo.com/user{id}"
      },
      {
        "id": "2",
        "name": "第二次按快捷键后url值为空"
