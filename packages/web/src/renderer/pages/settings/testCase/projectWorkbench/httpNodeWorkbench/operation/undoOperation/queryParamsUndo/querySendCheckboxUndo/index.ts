...
const node: ModelNode = {
  modelName: "querySendCheckboxUndo",
  ...
  atomicFunc: [
  {
    ...
    "precondition": [
      {
        "id": "1",
        "name": "已打开httpNode节点编辑页面,query参数表格中存在一行参数,是否发送选项初始为勾选状态"
      }
    ],
    "operationSteps": [
      {
        "id": "1",
        "name": "点击是否发送checkbox取消勾选"
      },
      {
        "id": "2",
        "name": "再次点击是否发送checkbox勾选"
      },
      {
        "id": "3",
        "name": "按ctrl+z快捷键"
    ...
    "expectedResults": [
      {
        "id": "1",
        "name": "第一次按快捷键后是否发送恢复为未勾选"
      },
      {
        "id": "2",
        "name": "第二次按快捷键后是否发送恢复为勾选"
      },
      {
        "id": "3",
  ...
  },
  {
    ...
    "expectedResults": [
      {
        "id": "1",
        "name": "第一次点击撤销后是否发送恢复为未勾选"
      },
      {
        "id": "2",
        "name": "第二次点击撤销后是否发送恢复为勾选"
      },
      {
        "id": "3",
