...
import type { ApidocProperty, ApidocVariable, HttpNodePropertyType, HttpNodeRequestParamTypes } from '../httpNode';
...
export type MatchedFieldType = typeof MatchedFieldType[keyof typeof MatchedFieldType];
...
//带匹配详情的项目信息
export type ProjectWithMatchDetails = ApidocProjectInfo & {
  matchedFields: MatchedFieldType[];
