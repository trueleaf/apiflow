...
test.describe('CutNode', () => {
  test.describe('剪切HTTP节点', () => {
    test('剪切单个httpNode节点粘贴到根节点下', async ({ contentPage, clearCache, createProject }) => {
      ...
      await contentPage.waitForTimeout(300);
      const cutItem = contentPage.locator('.s-contextmenu .contextmenu-item', { hasText: /剪切/ }).first();
    ...
    test('剪切多个httpNode节点粘贴到根节点下', async ({ contentPage, clearCache, createProject }) => {
      ...
      await contentPage.waitForTimeout(300);
      const batchCutItem = contentPage.locator('.s-contextmenu .contextmenu-item', { hasText: /批量剪切/ });
  ...
  test.describe('剪切文件夹节点', () => {
    ...
    test('剪切包含子节点的folder节点', async ({ contentPage, clearCache, createProject }) => {
      ...
      await cutItem.click();
      await contentPage.waitForTimeout(300);
      const targetFolder = contentPage.locator('.el-tree-node').filter({ hasText: '目标文件夹' });
      ...
      const childFolder = expandedTargetFolder.locator('.el-tree-node').filter({ hasText: '父文件夹' });
