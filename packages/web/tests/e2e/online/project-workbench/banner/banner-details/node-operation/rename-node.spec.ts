...
test.describe('RenameNode', () => {
  test.describe('重命名httpNode节点', () => {
    test('active节点,点击节点右键,点击重命名,输入名称,回车', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
    ...
    test('active节点,F2重命名,输入名称,回车', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
    ...
    test('点击节点更多操作,点击重命名,输入名称,blur', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
    ...
    test('节点名称未填写不允许重命名', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
