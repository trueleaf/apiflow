...
test.describe('CopyNode', () => {
  test.describe('复制HTTP节点', () => {
    ...
    test('复制单个httpNode节点粘贴到根节点下', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
    ...
    test('复制单个httpNode节点粘贴到folder节点下', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
    ...
    test('复制多个httpNode节点粘贴到根节点下', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
  ...
  test.describe('复制WebSocket节点', () => {
    ...
    test('复制单个websocketNode节点粘贴到根节点下', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
    ...
    test('复制单个websocketNode节点粘贴到folder节点下', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
  ...
  test.describe('复制HTTP Mock节点', () => {
    ...
    test('复制单个httpMockNode节点粘贴到根节点下', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
    ...
    test('复制单个httpMockNode节点粘贴到folder节点下', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
  ...
  test.describe('复制WebSocket Mock节点', () => {
    ...
    test('复制单个websocketMockNode节点粘贴到根节点下', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
    ...
    test('复制单个websocketMockNode节点粘贴到folder节点下', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
  ...
  test.describe('复制文件夹节点', () => {
    // 复制单个folder节点粘贴到根节点下
    test('复制单个folder节点粘贴到根节点下', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
    ...
    // 复制包含子节点的folder节点
    test('复制包含子节点的folder节点', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
  ...
  test.describe('复制混合节点', () => {
    // 批量复制不同类型节点
    test('批量复制不同类型节点粘贴到根节点下', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
  ...
  test.describe('快捷键复制粘贴', () => {
    ...
    test('使用Ctrl+C和Ctrl+V生成及粘贴副本节点', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
