...
test.describe('CutNode', () => {
  test.describe('剪切HTTP节点', () => {
    test('剪切单个httpNode节点粘贴到根节点下', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
    ...
    test('剪切单个httpNode节点粘贴到folder节点下', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
    ...
    test('剪切多个httpNode节点粘贴到根节点下', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
    ...
    test('剪切httpNode节点在非folder节点右键不显示粘贴选项', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
  ...
  test.describe('剪切WebSocket节点', () => {
    test('剪切单个websocketNode节点粘贴到根节点下', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
    ...
    test('剪切单个websocketNode节点粘贴到folder节点下', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
  ...
  test.describe('剪切HTTP Mock节点', () => {
    test('剪切单个httpMockNode节点粘贴到根节点下', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
    ...
    test('剪切单个httpMockNode节点粘贴到folder节点下', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
  ...
  test.describe('剪切WebSocket Mock节点', () => {
    test('剪切单个websocketMockNode节点粘贴到根节点下', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
    ...
    test('剪切单个websocketMockNode节点粘贴到folder节点下', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
  ...
  test.describe('剪切文件夹节点', () => {
    test('剪切单个folder节点粘贴到根节点下', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
    ...
    test('剪切包含子节点的folder节点', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
  ...
  test.describe('剪切混合节点', () => {
    test('批量剪切不同类型节点粘贴到根节点下', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
  ...
  test.describe('快捷键剪切粘贴', () => {
    test('使用Ctrl+X和Ctrl+V剪切粘贴节点', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
  ...
  test.describe('剪切特殊情况', () => {
    test('剪切节点后进行复制操作,原剪切内容被覆盖', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
