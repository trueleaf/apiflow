...
test.describe('DeleteNode', () => {
  test.describe('删除httpNode节点', () => {
    test('鼠标右键httpNode节点删除', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
    ...
    test('鼠标移动到httpNode节点,点击更多操作删除节点', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
  ...
  test.describe('删除websocketNode节点', () => {
    test('鼠标右键websocketNode节点删除', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
    ...
    test('按住ctrl鼠标左键批量选择websocketNode节点,鼠标右键批量删除', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
  ...
  test.describe('删除httpMockNode节点', () => {
    test('鼠标右键httpMockNode节点删除', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
    ...
    test('鼠标移动到httpMockNode节点,点击更多操作删除节点', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
    ...
    test('按住ctrl鼠标左键批量选择httpMockNode节点,鼠标右键批量删除', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
  ...
  test.describe('删除websocketMockNode节点', () => {
    test('鼠标右键websocketMockNode节点删除', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
    ...
    test('鼠标移动到websocketMockNode节点,点击更多操作删除节点', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
    ...
    test('按住ctrl鼠标左键批量选择websocketMockNode节点,鼠标右键批量删除', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
  ...
  test.describe('删除folder节点', () => {
    test('鼠标右键folder节点删除', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
    ...
    test('鼠标移动到folder节点,点击更多操作删除节点', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
    ...
    test('按住ctrl鼠标左键批量选择folder节点,鼠标右键批量删除', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
  ...
  test.describe('删除混合节点', () => {
    test('按住ctrl鼠标左键批量选择httpNode,websocketNode,httpMockNode,websocketMockNode,folder节点,鼠标右键批量删除', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
