...
test.describe('MoveNode', () => {
  test.describe('移动单个httpNode节点', () => {
    ...
    test('拖拽单个httpNode节点到banner空白区域,移动到根节点下', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
    ...
    test('拖拽单个httpNode节点到folder节点上,移动到folder节点下', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
    ...
    test('拖拽单个httpNode节点调整在同一层级的顺序', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
    ...
    test('拖拽httpNode节点到非folder节点中,操作被阻止', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
  ...
  test.describe('移动单个websocketNode节点', () => {
    ...
    test('拖拽单个websocketNode节点到banner空白区域,移动到根节点下', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
    ...
    test('拖拽单个websocketNode节点到folder节点上,移动到folder节点下', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
  ...
  test.describe('移动单个httpMockNode节点', () => {
    ...
    test('拖拽单个httpMockNode节点到banner空白区域,移动到根节点下', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
    ...
    test('拖拽单个httpMockNode节点到folder节点上,移动到folder节点下', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
  ...
  test.describe('移动单个websocketMockNode节点', () => {
    ...
    test('拖拽单个websocketMockNode节点到banner空白区域,移动到根节点下', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
    ...
    test('拖拽单个websocketMockNode节点到folder节点上,移动到folder节点下', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
  ...
  test.describe('移动单个folder节点', () => {
    ...
    test('拖拽单个folder节点到banner空白区域,移动到根节点下', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
    ...
    test('拖拽单个folder节点到folder节点上,移动到folder节点下作为子节点', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
    ...
    test('拖拽folder节点调整在同一层级的顺序', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
    ...
    test('拖拽folder节点到其自身子节点下,操作被阻止', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
    ...
    test('移动包含多层嵌套的folder节点,层级结构保持不变', async ({ contentPage, clearCache, createProject, createNode, loginAccount }) => {
      await clearCache();
