...
`;
  ...
  if (useMirror) {
    ...
    console.log('✅ NPM registry configured to use mirror (npmmirror.com)');
  } else {
    fs.writeFileSync(npmrcPath, defaultConfig, 'utf-8');
    console.log('✅ NPM registry configured to use default (npmjs.org)');
  }
}
...
try {
  ...
  console.error('❌ Error configuring NPM registry:', error.message);
  process.exit(1);
}
